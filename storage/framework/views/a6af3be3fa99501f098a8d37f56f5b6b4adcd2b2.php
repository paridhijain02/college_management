...
<div class="wrapper">
        <div class="sidebar">
            <ul>
                <li>
                    <a href="<?php echo e(route('register.welcome')); ?>">
                        <span class="item">Welcome</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('register.slogin')); ?>" >
                        <span class="item">Student Login</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('register.tlogin')); ?>"> <!-- class="active"-->
                        <span class="item">Teacher Login</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('register.alogin')); ?>">
                        <span class="item">Admin Login</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('sregister.signup')); ?>">
                        <span class="item">Student Register</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('tregister.signup')); ?>">
                        <span class="item">Teacher Register</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('student.view')); ?>">
                        <span class="item">Student View</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('teacher.view')); ?>">
