...
<html lang="en">
  ...
  <div id="contact">
    <div class="box">
  <form class="row g-3" action="<?php echo e(url('/')); ?>/ssignups" method="post">
   <!--<form class="row g-3" action="<?php echo e(url('/')); ?>/customers" method="post">
    ...
    -->
        ...
        <div class="col-md-6">
            ...
            <input type="" name="name" class="form-control" id="" value="<?php echo e(old('name')); ?>">
        ...
        <div class="col-md-6">
            ...
            <input type="" name="username" class="form-control" id="" value="<?php echo e(old('username')); ?>">
            <span class="text-danger">
        ...
        <input list="course" name="course" value="<?php echo e(old('course')); ?>">
        ...
        <input list="year" name="year" value="<?php echo e(old('year')); ?>">
